...
KHALTI_GATEWAY_URL = getenv('KHALTI_GATEWAY_URL', 'https://dev.khalti.com')
KHALTI_RETURN_URL  = getenv('KHALTI_RETURN_URL', 'http://localhost:8000/api/payment/verify/')
KHALTI_WEBSITE_URL = getenv('KHALTI_WEBSITE_URL', 'http://localhost:8000')

# Khalti Payment Gateway — Trainer merchant (receives payouts from admin)
KHALTI_TRAINER_SECRET_KEY  = getenv('KHALTI_TRAINER_SECRET_KEY', '')
KHALTI_TRAINER_PUBLIC_KEY  = getenv('KHALTI_TRAINER_PUBLIC_KEY', '')
KHALTI_TRAINER_RETURN_URL  = getenv('KHALTI_TRAINER_RETURN_URL', 'http://localhost:8000/api/payment/trainer-payout/verify/')
